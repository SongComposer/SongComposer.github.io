...
## Example 2
   ...
   **Vocal + Accompaniment :** <audio controls style="width: 30%;"><source src="resources/showcase/EN_song_2_acc.mp3" type="audio/wav">Your browser does not support the audio element.</audio>
...
## Example 3
   ...
   **Vocal + Accompaniment :** <audio controls style="width: 30%;"><source src="resources/showcase/EN_song_1_acc.mp3" type="audio/wav">Your browser does not support the audio element.</audio>
...
## Example 1
   ...
   **Vocal + Accompaniment :** <audio controls style="width: 30%;"><source src="resources/showcase/ZH_song_3_acc.mp3" type="audio/wav">Your browser does not support the audio element.</audio>
